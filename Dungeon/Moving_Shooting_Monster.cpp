#include "Moving_Shooting_Monster.h"

#include "Create_objects.h"


void Moving_Shooting_Monster::update(TileMap & map, Create_objects & o, Audio & audio, int Projectile_R, sf::IntRect k, int which_texture)
{
	if (isReloaded >= 1)
	{
...
Moving_Shooting_Monster::Moving_Shooting_Monster(sf::Texture const& texture, sf::Texture const & texture2) : Enemy(texture, texture2)
{

}


Moving_Shooting_Monster::~Moving_Shooting_Monster()
{
}
